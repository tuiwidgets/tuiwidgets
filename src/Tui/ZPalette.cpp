...
ZPalette ZPalette::black() {
    ...
    p.setColors({
        ...
        { "window.default.scrollbar.bg", { 0, 0x55, 0xaa}},
        { "window.default.scrollbar.control.fg", Colors::black},
        { "window.default.scrollbar.control.bg", Colors::cyan},
        { "window.default.text.fg", Colors::brightYellow},
        ...
        { "window.Colors::cyan.scrollbar.bg", Colors::black},
        { "window.Colors::cyan.scrollbar.control.fg", Colors::cyan},
        { "window.Colors::cyan.scrollbar.control.bg", Colors::black},
        ...
        { "window.Colors::cyan.control.disabled.bg", Colors::cyan},
        ...
        { "window.Colors::cyan.lineedit.bg", Colors::black},
